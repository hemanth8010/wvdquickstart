...
$body = @"
{
  "parameters": {
    "gitSource": {
      "url": "https://github.com/hemanth8010/wvdquickstart.git"
    }
  }
}
"@
...
$parameters = $parameters.Replace("[HostpoolType]", $HostpoolType)
$parameters = $parameters.Replace("[LoadBalancerType]", $LoadBalancerType)
